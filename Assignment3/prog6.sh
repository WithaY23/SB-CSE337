#!/bin/bash
#Test case 1:
#./prog6.sh words.txt wordsD.txt 
#hate
#love
#Standard test to see if code works
#Test case 2:
# ./prog6.sh punctuation.txt punctuationD.txt 
# With
# here
# Here
# oink
