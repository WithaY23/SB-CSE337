...
class Vehicle #superclass for vehicle types
  ...
  #subclasses pass in argument
  #print number of doors on specified vehicle, based on type
  def doorCount(d)
...
puts subaru.shut_down #Let's park the myCar!
...
puts dodge.shut_down #Let's park the myTruck!
puts dodge.current_speed #You are now going 0mph.
